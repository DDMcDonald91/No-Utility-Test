...
export default function Navigation() {
  return (
    ...
    <Container style={{width: '80%'}}>
      <Navbar.Brand className="section-title" href="#hero-container">No Utility Belt NFT</Navbar.Brand>
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="me-auto">
          ...
          <Nav.Link href="#utility-container">Utility</Nav.Link>
        ...
        <Connection />
        <Nav.Link href="https://www.twitter.com/NoUtilityBelts" target="_blank" rel="noreferrer noopener"><AiFillTwitterCircle style={{fontSize: '1.7rem', color: 'white'}} /></Nav.Link>
      </Navbar.Collapse>
    </Container>
  </Navbar>
  )
